...
routes.post('/esqueceu-senha', SessionValidator.forgot, SessionController.forgot)
routes.post('/redefinir-senha', SessionValidator.reset, SessionController.reset)
...
routes.post('/pedidos', onlyUsers, OrderController.post)
